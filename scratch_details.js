...
export const FreelancerVehicleDetailScreen: React.FC<FreelancerVehicleDetailScreenProps> = ({ navigation, route }) => {
...
fs.writeFileSync('src/screens/FreelancerVehicleDetailScreen.tsx', content);
