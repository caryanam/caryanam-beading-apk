...
interface FreelancerVehiclesScreenProps {
  navigation: any;
  onOpenMenu: () => void;
}
...
export const FreelancerVehiclesScreen: React.FC<FreelancerVehiclesScreenProps> = ({ navigation, onOpenMenu }) => {
  ...
  const handleDelete = async () => {
    ...
    setDeleting(true);
    try {
      const res = await freelancerService.deleteDraft(deleteTarget.inspectionId);
      if (res.success) {
                  ...
                  <View key={v.inspectionId} style={[styles.vehicleCard, { backgroundColor: cardBg, borderColor: colors.border }]}>
                    ...
                    <View style={[styles.actionsRow, { borderTopColor: colors.border }]}>
                      ...
                      {canEdit && (
                        <TouchableOpacity
                          style={styles.actionBtn}
                          onPress={() => navigation.navigate('FreelancerAddVehicle', { inspectionId: v.inspectionId })}
                          activeOpacity={0.8}
                        >
