      ...
      >
        ...
        <View style={styles.cardBody}>
          ...
          <View style={styles.cardBottomRow}>
            <View>
              <Text style={[styles.bidPriceLabel, { color: colors.mutedForeground, textTransform: 'uppercase' }]}>
                {isComingSoon ? 'PRICE' : isSoldOut ? 'WINNING BID' : v.highestBid > 0 ? 'HIGHEST BID' : 'STARTING BID'}
              </Text>
              <Text style={[styles.bidPriceValue, { color: colors.foreground }]}>
                {inr(isComingSoon ? v.basePrice : (v.highestBid > 0 ? v.highestBid : v.basePrice))}
              </Text>
            </View>
